...
- `us-equities-pure-alpha-research-plan.md`: staged research plan for the small-capacity beta-matched U.S. equities pure-alpha product, including the 2026-04-18 Phase 1 universe-builder start, Phase 2 beta-panel build, Phase 3 baseline signal diagnostics, Phase 4 beta-matched portfolio constructor, Phase 4B short-book diagnosis, Phase 4C residual-loser selector lab, Phase 4D tree-selector check, Phase 4E feature-independence analysis, Phase 4F feature-posterior diagnostics, Phase 4G robust feature-utility re-ranking, Phase 4H universe-prior study, and Phase 4I residual-target study
