...
- `us-equities-pure-alpha-research-plan.md`: staged research plan for the small-capacity beta-matched U.S. equities pure-alpha product, including the 2026-04-18 Phase 1 universe-builder start, Phase 2 beta-panel build, and Phase 3 baseline signal diagnostics
