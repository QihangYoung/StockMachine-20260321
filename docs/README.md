...
- `pure-alpha-beta-product-memo-20260507.md`: product-level memo for combining pure alpha with optional S&P 500 beta, including the hard `25%` safety-cushion constraint and its opportunity cost
- `us-equities-pure-alpha-research-plan.md`: staged research plan for the small-capacity beta-matched U.S. equities pure-alpha product, including the 2026-04-18 Phase 1 universe-builder start, Phase 2 beta-panel build, Phase 3 baseline signal diagnostics, Phase 4 beta-matched portfolio constructor, Phase 4B short-book diagnosis, Phase 4C residual-loser selector lab, Phase 4D tree-selector check, Phase 4E feature-independence analysis, Phase 4F feature-posterior diagnostics, Phase 4G robust feature-utility re-ranking, Phase 4H universe-prior study, Phase 4I residual-target study, Phase 4J residual-target-aware short selector, Phase 4K asymmetric universe constructor, Phase 4L top2000 feasibility audit, Phase 4M Ridge short-side selector, Phase 4N PCA-Ridge standalone short selector, and Phase 4O long-selector refresh with standalone selector performance as the stage-gating standard
- `us-equities-pure-alpha-next-paths-memo-20260418.md`: validation-only memo and execution summary for the three post-Phase4I paths: residual-target-aware short selection, asymmetric long/short universe construction, and top2000 feasibility gating
